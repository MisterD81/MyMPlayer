...
namespace ExternalOSDLibrary
{
  ...
  public class TVProgressControlElement : BaseElement
  {
    ...
    private void DrawProgressBar(Graphics graph)
    {
      ...
      int yPos = (_progressControl.YPosition + _progressControl.FillY) + ((_progressControl.Height - _progressControl.FillY * 2) / 2) - (_progressControl.FillHeight / 2);

      float fWidth = iWidth;
      fWidth /= 100.0f;
      fWidth *= _progressControl.Percentage1;
