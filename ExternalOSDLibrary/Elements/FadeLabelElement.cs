    ...
    public override void DrawElement(Graphics graph)
    {
      if (_wasVisible)
      {
        ...
        else
        {
          ...
          rectangle = alignment == GUIControl.Alignment.ALIGN_RIGHT ? new RectangleF(x - sizeF.Width, y, _label.Width, Math.Max(sizeF.Height, _label.Height)) : new RectangleF(x - (sizeF.Width / 2), y - (sizeF.Height / 2), _label.Width, Math.Max(sizeF.Height, _label.Height));
        }
